...
\vspace*{2ex} \noindent Schnute, J.T., Couture-Beil, A., Haigh, R., and Egeli, A. 2009. PBSmodelling 2.20: user's guide \red{revised from} \ital{Canadian Technical Report of Fisheries and Aquatic Sciences} \bold{2674}: vi + 170 pp.

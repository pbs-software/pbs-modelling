...
\vspace*{2ex} \noindent Schnute, J.T., Couture-Beil, A., Haigh, R., and Egeli, A. 2008. PBS Modelling 1.72: user's guide \red{revised from} \ital{Canadian Technical Report of Fisheries and Aquatic Sciences} \bold{2674}: v + 135 pp.

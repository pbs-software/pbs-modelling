...
\item[\code{...}] additional paramaters for the function \code{arrows}.
\end{ldescription}
\end{Arguments}
\begin{Details}\relax
...
& (i) file name matches both an expansion of a concantenation of a \\
...
used to load and set PBS options uing \code{getGUIoptions} and 
\code{setGUIoptions}.
\end{Description}
\begin{Usage}
\begin{verbatim}
...
\code{PBSmodelling} contains examples that illustrate models built uisng 
